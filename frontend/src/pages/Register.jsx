    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mx-auto mb-5 w-16 h-16 bg-gray-800 rounded-xl border border-gray-700 flex items-center justify-center shadow-sm">
            <svg 
          ...
          <p className="text-gray-400 text-sm">Join our community of professionals</p>
        </div>
